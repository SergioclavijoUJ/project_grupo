...
- git add .  
  Para agrega los archivos al área de preparación

- git commit -m "mensaje"  
  Para guardar los cambios incluyendo un mensaje definirndo que cambios se realizaron

- git branch nombre_rama  
  Crea una nueva rama

- git checkout nombre_rama  
  Cambia a la rama requerida

- git checkout -b nombre_rama  
  Se utiliza para crear una nueva rama y moverse a ella
